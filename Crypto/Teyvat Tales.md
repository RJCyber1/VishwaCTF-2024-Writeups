1. Find the script.js file in the source:
```
...
```
2. Enter the inputs specified by the js file to the page in order to get the ciphertext.
3. Decode the Enigma Cipher using the specified parameters in the source.js (see above).
